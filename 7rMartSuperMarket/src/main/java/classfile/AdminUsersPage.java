...
@FindBy(xpath="//a[@class='btn btn-rounded btn-danger']") private WebElement newUserClick;
@FindBy(xpath="(//input[@type='text'])[2]")private WebElement username;
@FindBy(xpath="(//input[@type='password'])[1]") private WebElement password;
@FindBy(xpath="(//select[@class='form-control'])[2]") private WebElement selectDropdown;
@FindBy(xpath="(//button[@type='submit'])[2]") private WebElement saveButton;

@FindBy(xpath="//a[@class='btn btn-rounded btn-primary']") private WebElement searchButton;
@FindBy(xpath="(//input[@class='form-control'])[1]") private WebElement searchuser;
